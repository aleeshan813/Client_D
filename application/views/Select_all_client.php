    ...
    <div class="pagetitle">
      ...
      <div class="p-2">
        ...
        <div class="p-1" role="group" aria-label="Basic example">
          <a class="btn btn-success w-30 p-2" href="<?php echo base_url();?>index.php/main/select_client">Select</a>
        </div>
                  ...
                  <table class="table table-bordered text-center" style="background-color: white;">
                    ...
                    <thead>
                      <tr class="text-center tr-client">
                        ...
                        <th scope="col">
                            <button class="btn btn-success" type="submit"><a href="<?php echo base_url();?>index.php/Main/select_client" style="color:white;">Select</a></button>
                        </th>
                      </tr>
                    </thead>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="form-check p">
                          <input class="form-check-input bg-danger" name="view_data[]" type="checkbox" value="<?php echo $row->id; ?>" id="flexCheckDefault" checked>
                        </div>
                      </td>
                    </tr>
